...
namespace SortTimer
{
    ...
    class MergeSortForGetArray
    {
        // Merges two subarrays of []arr.
        // First subarray is arr[l..m]
        // Second subarray is arr[m+1..r]
        void mMerge(ref int[] arr, int l, int m, int r)
        {
        ...
        public ref int[] sortRec(ref int[] arr, int l, int r)
        {
            if (l < r)
            {
                // Find the middle
                ...
                // second halves
                sortRec(ref arr, l, m);
                sortRec(ref arr, m + 1, r);

                // Merge the sorted halves
                mMerge(ref arr, l, m, r);
            }
